...
function Portfolio() {
  // Function to smoothly scroll to the home section
  const scrollToHome = () => {
    ...
    <div>
      ...
      <nav className="navbar">
        <div className="navbar-left">
          <a href="#home" className="logo" onClick={scrollToHome}>
            Shubhaharini
          </a>
      ...
      <div id="home" className="one">
        <h1 className="animate" style={{ color: "smokewhite" }}>
          Hey there..
        </h1>
        <div
        ...
        >
          ...
          <img
            src={profileImage}
            alt="Shubhaharini"
            className="profile-image glowing-image"
            style={{
              marginLeft: "auto",
        ...
        <a href="#hire-me" className="hire-me-btn">
          Hire Me
        </a>
